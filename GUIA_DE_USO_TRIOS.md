...
# Fluxo de avaliação do docente

1. Acesse `docente.html`.
2. Gere os códigos dos trios e, se desejar, exporte em CSV.
3. Receba de cada trio o PDF final e o arquivo `ENTREGA_...json`.
4. Importe o JSON na aba **Avaliação do trio**.
5. Confira as evidências automáticas em cada um dos 12 critérios.
6. Use a pontuação sugerida como referência e ajuste a **Nota docente** quando a análise das pranchas/PDF justificar.
7. Registre os pontos fortes, pontos a melhorar e o parecer final.
8. Clique em **Gerar / atualizar nota**.
9. Clique em **Gerar relatório PDF**. O relatório informa a nota final e mostra cada critério como ATINGIDO ou NÃO ATINGIDO/PARCIAL.
